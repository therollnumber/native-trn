...
export default function DigitalIDDemo() {
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerIcon}>🆔</Text>
        <Text style={styles.headerTitle}>Digital ID Card</Text>
        <Text style={styles.headerSubtitle}>Your digital identity card demo</Text>
      </View>
      <View style={styles.content}>
        <Text style={styles.contentText}>Digital ID Card Demo - Coming Soon!</Text>
      </View>
    </ScrollView>
  );
}

...
export function PANScreen({ onValidationComplete, context }) {
  ...
  const handleViewDocument = () => {
    Alert.alert('Document Viewer', 'Opening PAN document...');
  };

  const renderInputStep = () => (
    <View style={styles.stepContainer}>
      <View style={styles.stepHeader}>
        <FileText size={32} color="#4F7CFF" />
        <Text style={styles.stepTitle}>Enter PAN Details</Text>
        <Text style={styles.stepDescription}>
          Enter your PAN number and date of birth for verification
        </Text>
      </View>
      ...
      <View style={styles.inputContainer}>
        ...
        <Button
          ...
          loading={isLoading}
          disabled={panNumber.length !== 10 || !dateOfBirth}
        >
          Verify PAN
        </Button>
      </View>
      ...
      <View style={styles.securityNote}>
        ...
        <Text style={styles.securityText}>
          Your PAN data is encrypted and secure. We comply with Income Tax Department guidelines.
        </Text>
      </View>
    </View>
  );
  ...
  const renderVerifiedStep = () => (
    <View style={styles.stepContainer}>
      <View style={styles.stepHeader}>
        ...
        <Text style={styles.stepTitle}>PAN Verified</Text>
        <Text style={styles.stepDescription}>
      ...
      <View style={styles.verifiedData}>
        ...
        <View style={styles.dataRow}>
          ...
          <Text style={styles.dataValue}>{verifiedData?.panNumber}</Text>
        </View>
        ...
        <View style={styles.dataRow}>
          ...
          <Text style={styles.dataValue}>{verifiedData?.category}</Text>
        </View>
  ...
  const renderUploadStep = () => (
    <View style={styles.stepContainer}>
      <View style={styles.stepHeader}>
        ...
        <Text style={styles.stepDescription}>
          Please wait while we securely upload your PAN document...
        </Text>
      </View>
  ...
  const renderCompleteStep = () => (
    <View style={styles.stepContainer}>
      <View style={styles.stepHeader}>
        <CheckCircle size={32} color="#10B981" />
        <Text style={styles.stepTitle}>PAN Added Successfully</Text>
        <Text style={styles.stepDescription}>
          Your PAN card has been verified and added to your wallet
        </Text>
      </View>
      ...
      <View style={styles.successNote}>
        ...
        <Text style={styles.successText}>
          Your PAN verification is complete and can now be shared with verified organizations.
        </Text>
      </View>
    </View>
  );
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>PAN Card Verification</Text>
      ...
      {isFromVerificationRequest && (
        <View style={styles.contextMessage}>
          ...
          <Text style={styles.contextText}>
            PAN verification requested for background check
          </Text>
        </View>
      )}

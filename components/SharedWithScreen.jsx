...
export default function SharedWithScreen() {
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerIcon}>🤝</Text>
        <Text style={styles.headerTitle}>Shared Documents</Text>
        <Text style={styles.headerSubtitle}>View organizations with access</Text>
      </View>
      <View style={styles.content}>
        <Text style={styles.contentText}>Shared Documents - Coming Soon!</Text>
      </View>
    </ScrollView>
  );
}

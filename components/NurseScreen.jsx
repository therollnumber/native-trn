...
export default function NurseScreen({ onValidationComplete, context }) {
  ...
  const handleViewDocument = () => {
    Alert.alert('Document Viewer', 'Opening Nurse License document...');
  };

  const renderInputStep = () => (
    <View style={styles.stepContainer}>
      <View style={styles.stepHeader}>
        <Heart size={32} color="#4F7CFF" />
        <Text style={styles.stepTitle}>Enter Nurse License Details</Text>
        <Text style={styles.stepDescription}>
          Enter your nursing registration number and year of registration
        </Text>
      </View>
      ...
      <View style={styles.securityNote}>
        ...
        <Text style={styles.securityText}>
          Your nursing registration data is encrypted and secure. We verify directly with the Nursing Council.
        </Text>
      </View>
    </View>
  );
  ...
  const renderVerifiedStep = () => (
    <View style={styles.stepContainer}>
      <View style={styles.stepHeader}>
        ...
        <Text style={styles.stepTitle}>Nurse License Verified</Text>
        <Text style={styles.stepDescription}>
          Your nursing license has been successfully verified
        </Text>
      </View>
      ...
      <View style={styles.verifiedData}>
        ...
        <View style={styles.dataRow}>
          <Text style={styles.dataLabel}>Nursing Council:</Text>
  ...
  const renderUploadStep = () => (
    <View style={styles.stepContainer}>
      <View style={styles.stepHeader}>
        ...
        <Text style={styles.stepDescription}>
          Please wait while we securely upload your nurse license document...
        </Text>
      </View>
  ...
  const renderCompleteStep = () => (
    <View style={styles.stepContainer}>
      <View style={styles.stepHeader}>
        <CheckCircle size={32} color="#10B981" />
        <Text style={styles.stepTitle}>Nurse License Added Successfully</Text>
        <Text style={styles.stepDescription}>
          Your nurse license has been verified and added to your wallet
        </Text>
      </View>
      ...
      <View style={styles.successNote}>
        ...
        <Text style={styles.successText}>
          Your nurse license verification is complete and can now be shared with verified healthcare organizations.
        </Text>
      </View>
    </View>
  );
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Nurse License Verification</Text>
      ...
      {isFromVerificationRequest && (
        <View style={styles.contextMessage}>
          ...
          <Text style={styles.contextText}>
            Nurse license verification requested for professional verification
          </Text>
        </View>
      )}
